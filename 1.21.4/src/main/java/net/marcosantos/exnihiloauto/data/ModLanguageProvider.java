...
public class ModLanguageProvider extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		this.add(ModItems.AUTO_HAMMER.get(), "Automatic Hammer");
		this.add("tiles.title.hammer", "Auto Hammer");
		this.add(ModItems.AUTO_SIEVE.get(), "Automatic Sieve");
		this.add("tiles.title.sieve", "Auto Sieve");
		this.add(ModItems.AUTO_SILKER.get(), "Automatic Silker");
	...
	private void createCompressedBlockTrans(DeferredBlock<CompressedBlock> obj, String compressed) {
		this.add(obj.get().asItem(), obj.get().tier.name + " " + compressed);
	}
}
