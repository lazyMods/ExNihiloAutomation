...
public class AutoSilkerScreen extends AbstractContainerScreen<AutoSilkerMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float v, int mouseX, int mouseY) {
		...
		guiGraphics.blit(RenderType.GUI_TEXTURED, BACK, this.leftPos, this.topPos, 0, 0, this.imageWidth, this.imageHeight, 256, 256);
		this.renderEnergyBar(guiGraphics);
		this.renderSilkerTimer(guiGraphics);
		this.renderSilkwormTimer(guiGraphics);
		if (ExNihiloAuto.HAS_PATCHOULI) {
			guiGraphics.blit(RenderType.GUI_TEXTURED, BACK, this.leftPos + 177, this.topPos + 64, 204, 52, 28, 26, 256, 256);
		}
	}
	...
	private void renderEnergyBar(GuiGraphics guiGraphics) {
		...
		guiGraphics.blit(RenderType.GUI_TEXTURED, BACK, this.leftPos + 8, startY + (52 - (int) scaled), 204, 0, 16, (int) scaled, 256, 256);
	}
	...
	private void renderSilkerTimer(GuiGraphics guiGraphics) {
		...
		guiGraphics.blit(RenderType.GUI_TEXTURED, BACK, this.leftPos + 73, this.topPos + 33, 220, 0, (int) (timePer * 22), 16, 256, 256);
	}
	...
	private void renderSilkwormTimer(GuiGraphics guiGraphics) {
		...
		guiGraphics.blit(RenderType.GUI_TEXTURED, BACK, this.leftPos + 73, this.topPos + 52, 220, 16, (int) (timePer * 22), 5, 256, 256);
	}
